...
VALUES
    ('Youssef Mahmoud', 'youssef@gmail.com', '01100166205', 'male', 40, 'Doctor', '6789:;'),
    ('Tarek Mahmoud', 'tarek@gmail.com', '01158930495', 'male', 35, 'Patient', '6789:;'),
    ('Mohamed Abdellah', 'abdellah@gmail.com', '01002189852', 'male', 45, 'Doctor', '6789:;'),
    ('Mohamed Maher', 'maher@gmail.com', '01000000000', 'male', 28, 'admin', '6789:;'),
    ('Islam Abdelkarem', 'islam@gmail.com', '01158960495', 'male', 35, 'Patient', '6789:;');
...
INSERT INTO `schedules` (`doctor_id`, `appointment_limit`, `remain_limit`, `day`)
VALUES
    (1, 10, 10, 'Monday'),
    (1, 10, 9, 'Tuesday'),
    (2, 8, 8, 'Wednesday'),
...
VALUES
    (2, 1, 2, 1, 'Pending'), -- Jane Smith with John Doe
    (5, 2, 4, 1, 'Pending'); -- Bob with Dr. Alice
